...
const isNotActiveStyle =
  'flex items-center px-5 gap-3 text-gray-500 hover:text-black transition-all duration-200 ease-in-out capitilize';
const isActiveStyle =
...
const Sidebar = ({ user, closeToggle }) => {
  ...
  return (
    <div className="flex flex-col justify-betwwen bg-white h-full overflow-y-scrikk min-w-210 hide-scrollbar">
      <div className="flex flex-col">
        <Link
          to="/"
          className="flex px-5 gap-5 my-6 pt-1 w-190 item-center"
