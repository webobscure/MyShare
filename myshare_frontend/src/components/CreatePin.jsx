...
const CreatePin = ({ user }) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
          ...
          <div className="flex justify-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
            ...
            {!imageAsset ? (
              ...
              <div className="relative h-full">
                <img src={imageAsset?.url} alt="upload" className="h-full w-full" />
                <button
                  type="button"
            ...
            <div>
              ...
              <select
                ...
                {categories.map((category) => (
                  <option
                    className="text-base border-0 capitilize bg-white text-black"
                    value={category.name}>
                    {category.name}
                  </option>
                ))}
